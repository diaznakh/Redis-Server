...
// Common Commands RESP handlers
// These functions handle the RESP commands and return the appropriate RESP-formatted response.
// They take the command tokens and the RedisDatabase instance as parameters.
// The RedisDatabase instance is used to perform the actual operations on the database.
// The functions return a std::string containing the RESP-formatted response.
...
std::string RedisCommandHandler::processCommand(const std::string &commandLine)
{
    ...
    // If we reach here, it means the command was not recognized
